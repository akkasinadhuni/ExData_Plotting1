...
plot(data$Time, submetering1,type = "l",xlab="",ylab = "Global Active Power (kilowatts)")
plot(data$Time, submetering1, type= "l", xlab="", ylab="Energy sub metering")
lines(data$Time, submetering2, type= "l", col = "red", xlab="", ylab="Energy sub metering")
lines(data$Time, submetering3, type= "l", col = "blue", xlab="", ylab="Energy sub metering")
